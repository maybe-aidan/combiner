mod args;
use args::Args;
use image::{imageops::FilterType::Triangle, io::Reader, DynamicImage, GenericImageView, ImageError, ImageFormat};
...
impl FloatingImage {
    fn new(width: u32, height:u32, name: String) -> Self{
        let buffer_capacity = height * width * 4; // RBGA, four values per pixel
...
fn set_rgba(vec: &Vec<u8>, start: usize, end: usize) -> Vec<u8> {
    ...
    for i in start..=end { // Rust range based for loop syntax
